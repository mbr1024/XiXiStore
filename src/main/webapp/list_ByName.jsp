                ...
                <li id="cat_1" class="">
                    ...
                    <div id="cat_1_menu" class="cat_menu clearfix" style="">
                        <dl class="clearfix">
                            ...
                            <dd>
                                <a href="${pageContext.request.contextPath}/client/product/findProductByName.do?cname=连衣裙">连衣裙</a>
                                <a href="${pageContext.request.contextPath}/client/product/findProductByName.do?cname=半身裙">半身裙</a>
                                <a href="${pageContext.request.contextPath}/client/product/findProductByName.do?cname=牛仔裤">牛仔裤</a>
                                <a href="${pageContext.request.contextPath}/client/product/findProductByName.do?cname=打底衫">打底衫</a>
                                <a href="${pageContext.request.contextPath}/client/product/findProductByName.do?cname=毛呢大衣">毛呢大衣</a>
                                <a href="${pageContext.request.contextPath}/client/product/findProductByName.do?cname=毛呢短裤">毛呢短裤</a>
                            </dd>
                        ...
                        <dl class="clearfix">
                            <dt>男装</dt>
                            <dd>
                                <a href="${pageContext.request.contextPath}/client/product/findProductByName.do?cname=男装">风衣</a>
                                <a href="${pageContext.request.contextPath}/client/product/findProductByName.do?cname=毛呢短裤">长裤</a>
                                <a href="${pageContext.request.contextPath}/client/product/findProductByName.do?cname=毛呢短裤">短裤</a>
                                <a href="${pageContext.request.contextPath}/client/product/findProductByName.do?cname=毛呢短裤">短袖</a>
                                <a href="${pageContext.request.contextPath}/client/product/findProductByName.do?cname=毛呢短裤">长袖</a>
                                <a href="${pageContext.request.contextPath}/client/product/findProductByName.do?cname=毛呢短裤">羽绒服</a>
                                <a href="${pageContext.request.contextPath}/client/product/findProductByName.do?cname=毛呢短裤">保暖裤</a>
                            </dd>
                        </dl>
                    </div>
                </li>
    ...
    <div class="shop_bd_list_right clearfix">
        ...
        <div class="sort-bar">
            <div class="bar-l">
                ...
                <!-- 排序方式S -->
                <ul class="array">
                    <li class="selected"><a title="默认排序" class="nobg" href="${pageContext.request.contextPath }/client/product/findProductByName.do?search_content=${search_content}">默认</a></li>
                    <li><a title="点击按销量从高到低排序"
                           href="${pageContext.request.contextPath }/client/product/findProductByName.do?sales=1&search_content=${search_content}">销量</a></li>
                    <li><a title="点击按人气从高到低排序"
                           href="${pageContext.request.contextPath }/client/product/findProductByName.do?click=1&search_content=${search_content}">人气</a></li>
                    <li><a title="点击按价格从高到低排序"
                           href="${pageContext.request.contextPath }/client/product/findProductByName.do?price=1&search_content=${search_content}">价格</a></li>
                </ul>
                <!-- 排序方式E -->
                <!-- 价格段S -->
                <form action="${pageContext.request.contextPath }/client/product/findProductByName.do?search_content=${search_content}" method="post">
        ...
        <div class="shop_bd_list_content clearfix">
            ...
            <syl:pager
                    ...
                    style="digg"
                    submitUrl="${pageContext.request.contextPath}/client/product/findProductByName.do?pageIndex={0}&search_content=${search_content}&min=${condition.min}&max=${condition.max}&sales=${condition.sales}&click=${condition.click}&price=${condition.price}"/>
        </div>
        </td>
    </div>
    <div class="clear"></div>
