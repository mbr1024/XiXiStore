...
<script type="text/javascript">
  $(function(){
	  $.post(
		"${pageContext.request.contextPath}/admin/product/findProductCategory.do","",function(data){
			var content="";
...
<div style="padding:10px 10px 10px 10px">
	<form id="itemAddForm" action="${pageContext.request.contextPath}/admin/product/addProduct.do"  method="post" enctype="multipart/form-data">
	    <table cellpadding="5">
	        <tr>
	            <td>商品类目:</td>
	            <td>
