...
<table class="easyui-datagrid" id="itemList" title="商品列表"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'${pageContext.request.contextPath }/admin/product/findProductList.do',method:'post',pageSize:30,toolbar:toolbar">
    <thead>
    <tr>
...
<div id="itemEditWindow" class="easyui-window" title="编辑商品"
     data-options="modal:true,closed:true,iconCls:'icon-save',href:'${pageContext.request.contextPath }/jsp/item-edit.jsp'"
    ...
    var toolbar = [{
        ...
        handler: function () {
            ...
            $.messager.confirm('确认', '确定删除ID为 ' + ids + ' 的商品吗？', function (r) {
                if (r) {
                    var params = {"ids": ids};
                    $.post("${pageContext.request.contextPath}/admin/product/deleteProductById.do", params ,function(){
        ...
        handler: function () {
            ...
            $.messager.confirm('确认', '确定下架ID为 ' + ids + ' 的商品吗？', function (r) {
                if (r) {
                    var params = {"ids": ids};
                    $.post("${pageContext.request.contextPath}/admin/product/updateProductByflag.do?type=xia", params ,function(){
        ...
        handler: function () {
            ...
            $.messager.confirm('确认', '确定上架ID为 ' + ids + ' 的商品吗？', function (r) {
                if (r) {
                    var params = {"ids": ids};
                    $.post("${pageContext.request.contextPath}/admin/product/updateProductByflag.do?type=shang", params ,function(){
