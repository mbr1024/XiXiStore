		...
		<div class="shop_member_bd_right clearfix">
			...
			<div class="shop_meber_bd_good_lists clearfix">
				...
				<div class="shop_home_form">
					<form action="${pageContext.request.contextPath}/client/user/updatePassword.do" class="shop_form" method="post">
						<ul>
							...
							<li class="bn"><label>重复新密码：</label><input type="password" name="repassword" class="truename form-text" /></li>
