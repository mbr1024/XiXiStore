...
<div class="shop_hd_header">
    <div class="shop_hd_header_logo"><h1 class="logo"><a href="${pageContext.request.contextPath}/index_in.jsp"><img src="${pageContext.request.contextPath}/images/logo.png" alt="ShopCZ"/></a><span>ShopCZ</span>
    </h1></div>
                    ...
                    <tr>
                        <td colspan="5">
                            <table class="good">
                                ...
                                <tr>
                                    <th colspan="6">
                                        <span><strong>订单号码：</strong>${order.order_id }</span>
                                    </th>
                                </tr>
                                </thead>
                                <tbody>
                                <c:forEach items="${order.orderitems}" var="item">
                                    ...
                                    <tr>
                                        <td class="dingdan_pic"><img
                                                src="${pageContext.request.contextPath}/${item.product.pimage}"/></td>
                                        <td class="dingdan_title"><span><a href="${pageContext.request.contextPath}/client/product/findProductById.do?id=${item.product.pid}">${item.product.pname}</a></span></td>
                                        ...
                                        <td class="digndan_caozuo"><c:if test="${order.state==1}">
                                            <span>已付款</span>
                                        </c:if>
                                            <c:if test="${order.state==0}">
                                                <span style="color:red"><a href="${pageContext.request.contextPath}/client/order/pay.do?order_id=${item.order_id}&money=${item.subtotal}">未付款</a></span>
                                            </c:if>
