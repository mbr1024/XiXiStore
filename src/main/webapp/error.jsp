    ...
    <div class="shop_hd_topNav">
        <div class="shop_hd_topNav_all">
            ...
            <div class="shop_hd_topNav_all_left">
                <p>您好，欢迎来到<b><a href="${pageContext.request.contextPath }/">ShoopNC商城</a></b>[<a
                        href="${pageContext.request.contextPath }/login.jsp">登录</a>][<a
                        href="${pageContext.request.contextPath }/register.jsp">注册</a>]</p>
            </div>
            ...
            <div class="shop_hd_topNav_all_right">
                <ul class="topNav_quick_menu">
                    ...
                    <li>
                        <div class="topNav_menu">
                            <a href="#" class="topNavHover">买家中心<i></i></a>
                            <div class="topNav_menu_bd" style="display:none;">
                                <ul>
                    ...
                    <li>
                        <div class="topNav_menu">
                            <a href="#" class="topNavHover">购物车<b></b><i></i></a>
                            <div class="topNav_menu_bd" style="display:none;">
                                <!--
                                <ul>
                                  <li><a title="已售出的商品" target="_top" href="#">已售出的商品</a></li>
...
<div class="shop_bd_error">
    <p><span>出错了</span>未登录,请先<a href="${pageContext.request.contextPath}/login.jsp" >登陆</a></p>
</div>
<!-- Body End -->
