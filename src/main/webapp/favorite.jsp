		...
		<div class="shop_member_bd_right clearfix">
			...
			<div class="shop_bd_list_content clearfix">
				<ul>
                      ...
                      <c:forEach items="${list}" var="assess" >
                      <li>
						<dl>
							<dt><a href="${pageContext.request.contextPath}/client/product/findProductById.do?id=${assess.product.pid}"><img src="${pageContext.request.contextPath}/${assess.product.pimage }" /></a></dt>
							<dd class="title"><a href="${pageContext.request.contextPath}/client/product/findProductById.do?pid=${assess.product.pid}">${assess.product.pname }</a></dd>
							<dd class="content">
								<span class="goods_jiage">￥<strong>${assess.product.price }</strong></span>
								<span class="goods_chengjiao">最近成交${assess.product.succ_count}笔</span>
							</dd>
						</dl>
					</li>
                      </c:forEach>
