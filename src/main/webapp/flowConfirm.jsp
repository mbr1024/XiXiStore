...
<!-- 购物车 Body -->
<form id="formaddress" method="post" action="${pageContext.request.contextPath}/client/order/creatOrder.do">
    <div class="shop_gwc_bd clearfix">
        <div class="shop_gwc_bd_contents clearfix">
            ...
            <div class="shop_bd_shdz_title">
                <h3>收货人地址</h3>
                <p>
<%--                    <a href="${pageContext.request.contextPath}/client/address/addAddress.do?type=order" id="new_add_shdz_btn">新增收货地址</a>--%>
                    <a href="${pageContext.request.contextPath }/client/address/findAddress.do">管理收货地址</a>
                </p>
            </div>
            ...
            <script type="text/javascript">
                $(function () {
                    $.post(
                        "${pageContext.request.contextPath}/client/order/findAddress.do", "", function (data) {
                            var content = "";
            ...
            <div class="shop_bd_shdz clearfix">
                <div class="shop_bd_shdz_lists clearfix">
                    <ul id="address">
                        ...
                        <%--                        <li><label>寄送至：<span><input name='did' type='radio' checked='checked'--%>
                        <%--                                                    value="${n.did}"/></span></label><em>${n.province}--%>
                        <%--                        </em><em>${n.city}市</em><em>${n.area}区</em><em>${n.address}--%>
                        <%--                        </em><em>--%>
                        <%--                            ${n.name}(收)</em><em>${n.telephone}</em></li>--%>
                        <%--                    </ul>--%>
                </div>
                <!-- 新增收货地址 -->
                    ...
                    <div class="shdz_new_form">
                        <script type="text/javascript">
                            function submitFormAddress() {
                                $.post(
                                    "${pageContext.request.contextPath}/client/address/addAddress.do?type=order", $("#formaddress").serialize(), function (data) {
                                        jQuery("#new_add_shdz_contents").hide(500);
                                        $(":text").val("");
                        ...
                        <ul>
                            <li><label><span>*</span>收货人姓名：</label><input name="name" type="text" class="name"/>
                            </li>
                            <li><label><span>*</span>所在地址：</label>

                                省:<input name="province">
                                市:<input name="city">
                                区:<input name="area">
                            </li>
                            <li><label><span>*</span>详细地址：</label><input name="address" type="text"
                                                                         class="xiangxi"/></li>
                            <li><label><span></span>邮政编码：</label><input type="text" name="code" class="youbian"/>
                            </li>
                            <li><label><span></span>电话：</label><input type="text" name="phone" class="dianhua"/>
                            </li>
                            <li><label><span></span>手机号：</label><input name="telephone" type="text"
                                                                       class="shouji"/></li>
                            <li><label>&nbsp;</label><input onclick="submitFormAddress()" type="button"
                                                            value="增加收货地址"/></li>
                        </ul>
            ...
            <table>
                ...
                <c:forEach items="${cart}" var="entry">
                    ...
                    <tr>
                        <td class="gwc_list_pic"><a href=""><img style="width: 60px;height: 60px"
                                                                 src="${entry.key.pimage }"/></a></td>
                        <td class="gwc_list_title"><a href="">${entry.key.pname } </a></td>
                        <td class="gwc_list_danjia"><span>￥<strong id="danjia_001">${entry.key.price }</strong></span>
                        </td>
                        <td class="gwc_list_shuliang"><span><a class="good_num_jian this_good_nums" did="danjia_001"
                                                               xid="xiaoji_001" ty="-" valId="goods_001"
                                                               onclick="changeProductNum('${entry.value-1}','${entry.key.pnumber}','${entry.key.pid}')"
                                                               href="javascript:void(0);">-</a><input type="text"
                                                                                                      readonly
                                                                                                      value="${entry.value }"
                                                                                                      id="goods_001"
                                                                                                      class="good_nums"/><a
                                href="javascript:void(0);" did="danjia_001" xid="xiaoji_001" ty="+"
                                class="good_num_jia this_good_nums" valId="goods_001"
                                onclick="changeProductNum('${entry.value+1}','${entry.key.pnumber}','${entry.key.pid}')">+</a></span>
                        </td>

                        <td class="gwc_list_xiaoji"><span>￥<strong id="xiaoji_001"
                                                                   class="good_xiaojis">${entry.key.price*entry.value }</strong></span>
                        </td>
                        <td class="gwc_list_caozuo"><a style="margin: 0px"
                                                       href="${pageContext.request.contextPath}/client/collect/addFavorite.do?pid=${entry.key.pid}">收藏</a><a
                                style="margin-left: 5px"
                                href="${pageContext.request.contextPath }/client/order/changeProduct.do?pid=${entry.key.pid}&&count=0"
                ...
                <tr>
                    <td colspan="6">
                        <div class="gwc_foot_zongjia">商品总价(不含运费)<span>￥<strong
                                id="good_zongjia">${total }</strong></span>
                        ...
                        <div class="gwc_foot_links">
                            ...
                            <%--                            <button type="submit" class="op">确认订单</button>--%>
                            <script type="text/javascript">
                                ...
                                <%--    window.location.href = "${pageContext.request.contextPath}/client/order/creatOrder.do?did=${n.did}";--%>
                                <%--}--%>
                            </script>
                        </div>
                    </td>
