...
<body>
	...
	<div class="main">
		<div class="login-form fr">
			...
			<div class="form-bd">
				<form action="${pageContext.request.contextPath }/client/user/register.do" method="post">
					<dl>
						<dt>用户名</dt>
					...
					<dl>
						<dt>验证码</dt>
						<dd><input type="text" name="code" class="text" size="10" style="width:58px;"> <img id="img" onclick="cheImg()" src="${pageContext.request.contextPath }/imageCode" /></dd>
					</dl>
